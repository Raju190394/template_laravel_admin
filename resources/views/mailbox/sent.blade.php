                ...
                <div class="row mb-4">
                    <div class="col-md-3">
                        <div class="list-group">
                            ...
                            <a href="{{ route('mailbox.sent') }}" class="list-group-item list-group-item-action active">
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="d-flex justify-content-between mb-3">
                            <form action="{{ route('mailbox.sent') }}" method="GET" class="d-flex">
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        @empty
                                        <tr>
                                            <td colspan="5" class="text-center py-4">No sent messages found.</td>
                                        </tr>
                                        @endforelse
                                    </tbody>
                                </table>
