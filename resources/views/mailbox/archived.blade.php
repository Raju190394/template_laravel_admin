        ...
        <div class="col-12">
            <div class="bg-white rounded h-100 p-4">
                <div class="d-flex align-items-center justify-content-between mb-4">
                    <h6 class="mb-0">Archived Messages</h6>
                ...
                <div class="row mb-4">
                    <div class="col-md-3">
                        <div class="list-group">
                            ...
                            <a href="{{ route('mailbox.archived') }}" class="list-group-item list-group-item-action active">
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="d-flex justify-content-between mb-3">
                            <form action="{{ route('mailbox.archived') }}" method="GET" class="d-flex">
                            ...
                            <div>
                                <button form="bulk-delete-form" type="submit" class="btn btn-sm btn-danger" onclick="return confirm('Permanently delete selected messages?')">
                                    <i class="fa fa-trash me-2"></i>Delete Forever
                                </button>
                            </div>
                        </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        @empty
                                        <tr>
                                            <td colspan="5" class="text-center py-4">No archived messages found.</td>
                                        </tr>
                                        @endforelse
                                    </tbody>
                                </table>
