            ...
            <div class="bg-light rounded h-100 p-4">
                <div class="d-flex align-items-center justify-content-between mb-4">
                    <h6 class="mb-0 text-primary">
                        <i class="fa fa-{{ isset($school_setting) ? 'edit' : 'plus' }} me-2"></i>
                        {{ isset($school_setting) ? 'Edit' : 'Add' }} School Settings
                    </h6>
                ...
                <form action="{{ isset($school_setting) ? route('master.school-settings.update', $school_setting) : route('master.school-settings.store') }}" 
                      method="POST" enctype="multipart/form-data">
                    @csrf
                    @if(isset($school_setting))
                        @method('PUT')
                    @endif
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control @error('school_name') is-invalid @enderror" 
                                       ...
                                       value="{{ old('school_name', $school_setting->school_name ?? '') }}" 
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating mb-3">
                                        <input type="email" class="form-control @error('email') is-invalid @enderror" 
                                               id="email" name="email" 
                                               value="{{ old('email', $school_setting->email ?? '') }}" 
                                               placeholder="Email">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control @error('phone') is-invalid @enderror" 
                                               id="phone" name="phone" 
                                               value="{{ old('phone', $school_setting->phone ?? '') }}" 
                                               placeholder="Phone">
                            ...
                            <div class="form-floating mb-3">
                                <input type="url" class="form-control @error('website') is-invalid @enderror" 
                                       ...
                                       value="{{ old('website', $school_setting->website ?? '') }}" 
                            ...
                            <div class="form-floating mb-3">
                                <textarea class="form-control @error('address') is-invalid @enderror" 
                                          ...
                                          placeholder="Address" style="height: 100px;">{{ old('address', $school_setting->address ?? '') }}</textarea>
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control @error('city') is-invalid @enderror" 
                                               id="city" name="city" 
                                               value="{{ old('city', $school_setting->city ?? '') }}" 
                                               placeholder="City">
                                ...
                                <div class="col-md-3">
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control @error('state') is-invalid @enderror" 
                                               id="state" name="state" 
                                               value="{{ old('state', $school_setting->state ?? '') }}" 
                                               placeholder="State">
                                ...
                                <div class="col-md-3">
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control @error('pincode') is-invalid @enderror" 
                                               ...
                                               value="{{ old('pincode', $school_setting->pincode ?? '') }}" 
                                               placeholder="Pincode">
                            ...
                            <div class="form-floating mb-3">
                                <input type="url" class="form-control @error('youtube_link') is-invalid @enderror" 
                                       ...
                                       value="{{ old('youtube_link', $school_setting->youtube_link ?? '') }}" 
                            ...
                            <div class="form-floating mb-3">
                                <input type="url" class="form-control @error('facebook_link') is-invalid @enderror" 
                                       ...
                                       value="{{ old('facebook_link', $school_setting->facebook_link ?? '') }}" 
                            ...
                            <div class="form-floating mb-3">
                                <input type="url" class="form-control @error('instagram_link') is-invalid @enderror" 
                                       ...
                                       value="{{ old('instagram_link', $school_setting->instagram_link ?? '') }}" 
                            ...
                            <div class="form-floating mb-3">
                                <textarea class="form-control @error('description') is-invalid @enderror" 
                                          ...
                                          placeholder="Description" style="height: 100px;">{{ old('description', $school_setting->description ?? '') }}</textarea>
                        ...
                        <div class="col-md-4">
                            ...
                            @if(isset($school_setting) && $school_setting->logo)
                                <div class="mb-3 text-center">
                                    <img src="{{ asset('storage/' . $school_setting->logo) }}" 
                    ...
                    <div class="d-flex justify-content-end mt-4">
                        ...
                        <button type="submit" class="btn btn-primary">
                            <i class="fa fa-save me-1"></i>{{ isset($school_setting) ? 'Update' : 'Create' }} Settings
                        </button>
                    </div>
                </form>
            </div>
