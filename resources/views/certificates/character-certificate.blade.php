...
<body>
    ...
    <div class="content">
        ...
        to <strong>{{ date('d-m-Y') }}</strong>.</p>

        <p>During his/her stay in this institution, he/she has maintained 
        <strong>{{ $character_remarks }}</strong>. 
        He/She was regular and punctual in attendance and showed keen interest in academics and co-curricular activities.</p>

        <p>His/Her behavior with teachers and fellow students was courteous and respectful. 
        He/She has always been obedient and disciplined.</p>

        <p>We wish him/her all success in his/her future endeavors.</p>
    </div>
